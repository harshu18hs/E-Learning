...
namespace DataAccessLayer
{
    public class ArticleRepository : IArticleRepository
    {
        ...
        public ArticleRepository(ApplicationDbContext databaseContext, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public ActionResult<bool> DeleteArticle(string fileName)
        {
            ...
            {
                string path = _webHostEnvironment.WebRootPath + "C:\\Users\\harshita.sharma\\source\\repos\\ELearning_System\\ELearning\\Resource\\";
                ...
                List<ArticleUpload> UploadedFiles = _databaseContext.Resources.ToList();
                foreach (ArticleUpload file in UploadedFiles)
                {
                    if ((file.fileName + ".docx") == fileName)
                    {
                        _databaseContext.Resources.Remove(file);
        ...
        public ActionResult<string> DownloadArticle(string fileName)
        {
            ...
            else
            {
                ...
                {
                    var stream = new FileStream(jpegFilePath, FileMode.Open);
                    return new FileStreamResult(stream, "image/docx");
                }
        ...
        public ActionResult<bool> ArticleUpload(List<IFormFile> fileName)
        {
            ...
            {
                var basePath = Path.Combine(Directory.GetCurrentDirectory() + "\\Resource\\");
                ...
                if (!File.Exists(filePath))
                {
                    ...
                    var ArticleUpload = new ArticleUpload
                    {
                    ...
                    _databaseContext.Resources.Add(ArticleUpload);
                    _databaseContext.SaveChanges();
                    return true;
                }
            }
